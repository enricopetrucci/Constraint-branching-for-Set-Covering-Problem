                ...
                for e in repeated_first:
                    for f in sort:
                        for g in files:
                            ...
                            out.write("srun ./main.o -file "+ g + " -scoreComparison 1" + " -callback "+ str(callback) + " -branching " + str(branching) + " -constraintBranchVer " + str(constraintBranchVer) + " -delta " + str(a) + " -seed " + str(c) + " -time_limit "+ str(timelimit) + " -threads " + str(threads) + " -storeResults " + str(storeResults) + " -lookAhead "+ str(b) + " -reverse " + str(d) + " -repeatedFirst " + str(e) + " -sort " + str(f) + " -average " + "0\n")
